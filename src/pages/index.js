...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center h-full bg-black bg-opacity-50 relative z-10 px-4 sm:px-6 lg:px-8">
        <h1 className="text-white text-3xl px-2 sm:text-4xl md:text-5xl font-bold mb-4 text-center">
          Together We Can Combat Climate Change
        </h1>
        <p className="text-white text-base sm:text-lg md:text-xl px-2 mb-8 text-center">
          Join us in the fight for a sustainable future
        </p>
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/maps" legacyBehavior>
            <a className="border-2 border-blue-500 text-blue-500 px-4 py-2 rounded-md hover:bg-blue-500 hover:text-white text-center">
              Maps visualizer
            </a>
          </Link>
          <Link href="/donate" legacyBehavior>
            <a className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 text-center">
              Donate Now
            </a>
          </Link>
        </div>
      ...
      <div className="w-11/12 md:w-10/12 mx-auto py-16">
        <h2 className="text-4xl font-bold mb-6 text-center text-secondary-blue">
          About Climate Change
        </h2>
        ...
        <div className="flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 md:space-x-6">
          <div className="w-full md:w-1/3 p-6 bg-secondary-blue rounded-lg shadow-lg transition-transform transform hover:scale-105">
            ...
            <p className="text-center">
              Rising sea levels, extreme weather events, loss of biodiversity, and impacts on human health are just some of the significant effects of climate change.
            </p>
          </div>
          <div className="w-full md:w-1/3 p-6 bg-secondary-blue rounded-lg shadow-lg transition-transform transform hover:scale-105">
            <h3 className="text-2xl font-semibold mb-4 text-center">Statistics</h3>
            <p className="text-center">
              Global temperatures have risen by 1.2&deg;C since pre-industrial times. The last decade has been the warmest on record, with 2020 being one of the hottest years ever.
            </p>
          </div>
          <div className="w-full md:w-1/3 p-6 bg-secondary-blue rounded-lg shadow-lg transition-transform transform hover:scale-105">
        ...
        <section
      className="relative w-full p-8 bg-cover bg-center"
      style={{ backgroundImage: 'url("../images/news1.jpg")' }}
    >
      ...
      <div className="relative w-11/12 md:w-10/12 mx-auto py-16 text-gray-100">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-primary bg-opacity-75 backdrop-blur-sm p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              ...
              <Link href="/blog/article-slug-1" legacyBehavior>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-primary bg-opacity-75 backdrop-blur-sm p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              ...
              <Link href="/blog/article-slug-2" legacyBehavior>
                <a className="text-primary hover:underline">Read more</a>
              </Link>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-primary bg-opacity-75 backdrop-blur-sm p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              ...
              <Link href="/blog/article-slug-3" legacyBehavior>
                <a className="text-primary hover:underline">Read more</a>
              </Link>
            </div>
          </div>
        ...
        <div className="text-center mt-8">
          <Link href="/blog" legacyBehavior>
            <a className="text-primary text-lg px-4 py-2 border-2 border-white rounded transition duration-300 ease-in-out hover:bg-white hover:text-black hover:rounded-lg">
              View All
            </a>
          </Link>
        </div>
        ...
        <section className="w-full p-8 bg-primary text-primary">
      <div className="w-11/12 md:w-10/12 mx-auto py-16">
        <h2 className="text-4xl font-bold mb-8 text-center text-secondary-blue">
          Impact & Solutions
        </h2>
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 p-4">
            <div className="bg-secondary-blue p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              <h3 className="text-2xl font-semibold mb-4 text-white">Problems</h3>
              <p className="text-gray-200">
                Description of the problems caused by climate change...
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 p-4">
            <div className="bg-secondary-blue p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              <h3 className="text-2xl font-semibold mb-4 text-white">Solutions</h3>
              <p className="text-gray-200">
                Outline potential solutions and actions being taken...
              </p>
            </div>
          </div>
        </div>
        ...
        <section
      className="relative w-full p-8 bg-cover bg-center"
      style={{ backgroundImage: 'url("../images/news2.jpg")' }}
    >
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-primary p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
              ...
              <p className="text-gray-800">Brief description of the interactive feature...</p>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="bg-primary p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
      ...
      <div className="w-11/12 md:w-10/12 mx-auto text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row justify-center items-center">
          ...
          <button
            type="submit"
            className="bg-secondary-blue text-white px-6 py-2 rounded-md shadow-md hover:bg-blue-600 transition-colors duration-300"
          >
            Subscribe
          </button>
        </form>
